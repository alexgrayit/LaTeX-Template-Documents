% !TEX root = report template guide.tex
...
\usepackage[]{todo} %use [disable] option to turn off all todo functions
...
\usepackage{listings, lstautogobble} % code text environment
...
% Example Code Blocks For Using Files

% MATLAB example
% ~

% {
% \lstinputlisting[frame=single, numbers=left, style=Matlab-editor, language=matlab, basicstyle=\codesize, breaklines=true]{<filepath>}
% \captionof{lstlisting}{Caption Text}
% \label{lst: label}
% }
...
% {
% \lstinputlisting[frame=single, numbers=left, style=python, language=python, basicstyle=\codesize, breaklines=true]{<filepath>}
% \captionof{lstlisting}{Caption Text}
% \label{lst: label}
% }
...
\newcommand{\coderef}[1]{\mbox{\hyperref[#1]{listing\hspace{2pt}}\ref{#1}}}
...
% Can type extra text or use \arabic{}, \roman{}, \Alph{}, etc
...
% Custom formatting of ToC, fuck with at your own risk
\renewcommand{\cftsecleader}{\bfseries\cftdotfill{\cftdotsep}} % adds dots between section titles and page numbers in ToC
% \cftsetindents{entry}{indent}{numwidth}
% \cftsetindents{section}{0em}{2.5em}
% \cftsetindents{subsection}{2.5em}{3.2em}
% \cftsetindents{subsubsection}{5.7em}{4em}
% \cftsetindents{paragraph}{6.2em}{3.7em} % subsubsubsections -- by default don't appear in ToC
...
\newcommand{\Unit}{}
\newcommand{\Class}{}
\newcommand{\Assignment}{A Guide to Using the Report Template}
\newcommand{\SID}{}

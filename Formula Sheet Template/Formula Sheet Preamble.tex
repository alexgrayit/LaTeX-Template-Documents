...
\newcommand{\secrefNameNum}[1]{\mbox{\hyperref[#1]{\S}\ref{#1}\hyperref[#1]{:\hspace{1pt}}\nameref{#1}}} % ref with Num:Name
...
\newcommand{\secref}[1]{\secrefName{#1}} % choose method of section reference
...
\fancyhead[L]{\leftmark} % Left header - last section on page
...
\fancyhead[L]{\leftmark} % Left header - last section on page
\fancyhead[R]{\@title~\Year} % Right Header
\fancyfoot[C]{\thepage} % Puts page number bottom centre

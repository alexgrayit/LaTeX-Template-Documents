...
\include{Formula Sheet Preamble.tex}
...
\begin{document}
    ...
    \section{The Custom Commands / Macros}
        ...
        \subsection{Multi-Column Commands}
            ...
            \verb+\begin{paracol}{<n>}+ $\cdots$\verb+\end{paracol}+\\
            A paragraph column environment with \verb+<n>+ columns, has better text alignment than other packages in the use case of formula sheets.
